      ...
      <div ref={containerRef} className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          {sponsorshipTiers.map((tier, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className={`relative bg-card/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 border-2 ${tier.borderColor} shadow-xl ${tier.glowColor} group-hover:shadow-2xl transition-all duration-500 group-hover:scale-[1.02] group-hover:-translate-y-2`}>
                {/* Tier Badge */}
                ...
                {/* Icon */}
                <div className="mt-4 sm:mt-6 mb-5 sm:mb-8 flex justify-center">
                  <div className={`p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl bg-gradient-to-br ${tier.bgGradient} border ${tier.borderColor}`}>
                    <tier.icon className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 ${tier.textColor}`} />
                  </div>
                </div>

                {/* Amount */}
                <div className="text-center mb-4 sm:mb-6">
                  <span className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold bg-gradient-to-r ${tier.gradient} bg-clip-text text-transparent`}>
                    {tier.amount}
                  </span>
                </div>
        ...
        >
          ...
          <div className="relative glass-card-elevated rounded-2xl sm:rounded-3xl p-5 sm:p-8 lg:p-12 text-center border border-primary/20">
            ...
            {/* QR Code Placeholder */}
            <div className="mx-auto w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 bg-white rounded-xl sm:rounded-2xl shadow-lg flex items-center justify-center mb-5 sm:mb-8 border-4 border-primary/20">
              <div className="text-center p-3 sm:p-4">
                <QrCode className="w-12 h-12 sm:w-16 sm:h-16 text-muted-foreground mx-auto mb-2" />
                <span className="text-xs sm:text-sm text-muted-foreground">Payment QR Code</span>
              </div>
            </div>
            ...
            <button className="inline-flex items-center gap-2 px-5 sm:px-8 py-3 sm:py-4 rounded-full bg-gradient-to-r from-primary via-primary to-accent text-white text-sm sm:text-base font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
